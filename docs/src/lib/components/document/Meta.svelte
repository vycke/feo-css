...
<aside class="sticky post-0 p-1 flex-col mb-1 self-start">
	{#if doc.headers.length}
		<div class="mb-3 stack stack-g-00">
	...
	<div class="flex-row items-center">
		<Icon class="text-gray-2" name={categories[doc.category] || 'circle'} attrs={{ height: 18 }} />
	...
	{#if doc.source}
		...
		<div class="flex-row items-center">
			<Icon class="text-gray-2" name="github" attrs={{ height: 18 }} />
	...
	<div class="flex-row items-center">
		<Icon class="text-gray-2" name="calendar" attrs={{ height: 18 }} />
